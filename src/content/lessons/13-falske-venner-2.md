...
## Ord med dubbel betydelse på danska

Vissa danska ord rymmer två betydelser i samma form. Sammanhanget avgör – men det gör också att en svensk lätt låser fast vid fel tolkning.
...
Här betyder det danska ordet något *snävare* eller *annat* än det svenska ordet du tror dig känna igen.
...
Och så ett vardagligt: <span lang="da">grineren</span> är slang för något *skojigt/lattjo* (av <span lang="da">grine</span> = skratta). Hör du <span lang="da">"Det var grineren!"</span> betyder det "det var skoj", inte att någon grinade.

Träna alla orden i **flashcards** (tagg `falsk-ven`) tills betydelserna sitter rätt.
